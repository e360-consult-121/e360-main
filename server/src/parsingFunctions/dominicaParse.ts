...
export type ParsedDominicaXXXData = {
    formId: string;
    visaTypeName : string;
...
export const parseDominicaData = (rawData: DominicaRawData): ParsedDominicaXXXData => {
    const profession = rawData?.q42_whichBest42 || "";

    const parsedData: ParsedDominicaXXXData = {
