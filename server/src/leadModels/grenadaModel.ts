...
export interface ILeadGrenada extends ILead {
  additionalInfo: {
...
const LeadGrenadaSchema = new Schema<ILeadGrenada>({
  additionalInfo: {
...
export const LeadGrenadaModel = LeadModel.discriminator<ILeadGrenada>(
  "LeadGrenada",
  LeadGrenadaSchema
);
