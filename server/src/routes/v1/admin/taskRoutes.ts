...
router.get(
  ...
  authenticate,
  authorizeAdmin,
  asyncHandler(taskInfoControllers.fetchAllTasks)
);
router.get(
  "/fetchMyTasks",
  authenticate,
  authorizeAdmin,
  asyncHandler(taskInfoControllers.fetchMyTasks)
);
...
router.get(
  ...
  authenticate,
  authorizeAdmin,
  asyncHandler(otherInfoControllers.getAssigneeList)
);
...
router.post(
  ...
  authenticate,
  authorizeAdmin,
  asyncHandler(otherInfoControllers.addRemark)
);
