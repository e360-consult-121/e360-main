...
export const getDubaiMessage=(clientName:string , visaType : string ,stepName : string ,adminName : string ,investmentOption : string = "", messageId:string)=>{
    let message = '';
    switch (messageId) {
        ...
        case 'dubai-admin-medical-certificate-uploaded':
            message = `[${visaType}-${clientName}] ${stepName} : Admin (${adminName}) Uploaded medical certificate for the client `;
            break;

    

        case 'dubai-admin-emirates-visa-approved':
            message = `[${visaType}-${clientName}] ${stepName} : Admin (${adminName}) Uploaded Visa & Emirates ID  for the client `;
            break;

            
        case 'dubai-user-additional-documents-uploaded':
            message = `[${visaType}-${clientName}] ${stepName} : Client uploaded additional documents`;
            break;
        case 'dubai-admin-additional-documents-approved':
            message = `[${visaType}-${clientName}] ${stepName} : Admin (${adminName}) approved  additional documents uploaded by client`;
            break;


        case 'dubai-admin-bank-account-opened':
            message = `[${visaType}-${clientName}] ${stepName} : Admin (${adminName}) opened UAE bank account for the client`;
            break;
