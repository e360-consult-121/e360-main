...
exports.parseDomiGrenaData = parseDomiGrenaData;
...
//     return parsedData;
// };
const dominicaParse_1 = require("./dominicaParse");
const grenadaParse_1 = require("./grenadaParse");
function parseDomiGrenaData(data) {
    ...
    if (visaTypeName.includes("Dominica")) {
        return (0, dominicaParse_1.parseDominicaData)(data);
    }
    else if (visaTypeName.includes("Grenada")) {
        return (0, grenadaParse_1.parseGrenadaData)(data);
    }
    else {
