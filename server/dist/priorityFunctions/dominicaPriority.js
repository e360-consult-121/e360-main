...
exports.getDominicaPriority = void 0;
const enums_1 = require("../types/enums/enums");
const getDominicaPriority = (data) => {
    ...
    switch (data.profession) {
        case "Business Owner / Entrepreneur":
            ...
            else if (data.businessOwner.registeredBusiness === "No, I do not own a business") {
                scores.push(1); // LOW
            }
        ...
        case "Investor":
            ...
            if (data.investor.readyToInvest ===
            ...
            else if (data.investor.readyToInvest === "No, I do not have the funds") {
                scores.push(1); // LOW
            }
            // Question 2: Which investment route are you considering?
            if (data.investor.investmentRoute ===
                "Government Fund Contribution ($100,000+)" ||
                data.investor.investmentRoute === "Real Estate Investment ($200,000+)") {
                scores.push(3); // HIGH
            }
            else if (data.investor.investmentRoute === "Not sure yet, exploring options") {
                scores.push(2); // MEDIUM
            }
            else {
                scores.push(1); // LOW (default for other responses)
        ...
        case "High-Net-Worth Individual (HNWI)":
            ...
            if (data.HNWI.citizenshipReason === "Investment" ||
        ...
        case "Employee / Professional":
            ...
            if (data.employee.isInvestmentCapitalReady ===
                "Yes, I have at least $150,000") {
                scores.push(3); // HIGH
            }
            else if (data.employee.isInvestmentCapitalReady === "I need financing options") {
                scores.push(2); // MEDIUM
            }
            else if (data.employee.isInvestmentCapitalReady === "No, I do not have the funds") {
                scores.push(1); // LOW
            }
            break;
        case "Other":
...
exports.getDominicaPriority = getDominicaPriority;
