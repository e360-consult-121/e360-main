...
const visaApplicationController = __importStar(require("../../../controllers/user/visaApplication"));
// import { authenticate } from "../../../middlewares/authenticate";
// import asyncHandler from "../../../utils/asyncHandler";
// import * as visaApplicationController from "../../../controllers/user/visaApplication";
const router = (0, express_1.Router)();
router.route("/application").get(authenticate_1.authenticate, (0, asyncHandler_1.default)(visaApplicationController.getAllApplications));
router.route("/previousapplication").get(authenticate_1.authenticate, (0, asyncHandler_1.default)(visaApplicationController.getAllPreviousApplications));
