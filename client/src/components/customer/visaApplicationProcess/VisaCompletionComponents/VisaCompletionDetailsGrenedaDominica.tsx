...
const VisaCompletionDetailsGrenedaDominica = (stepStatusId:string) => {

  const { data, isLoading, isError } = useFetchDeliveryDetailsQuery(stepStatusId);
        ...
        <Stack spacing={4}>
          ...
          <Box>
            ...
            <Typography variant="body2" mb={1}>
              <strong>Recipient Name:</strong> Not Available
            </Typography>
            <Typography variant="body2" mb={1}>
              <strong>Delivery Address:</strong> Not Available
            </Typography>
            <Typography variant="body2" mb={1}>
              <strong>Contact Number:</strong> Not Available
            </Typography>
            <Typography variant="body2">
              <strong>Estimated Delivery Date:</strong> Not Available
            </Typography>
          </Box>
          ...
          <Box>
            ...
            <Typography variant="body2" mb={1}>
              <strong>Courier Service:</strong> {shippingDetails.courierService || 'N/A'}
            </Typography>
            <Typography variant="body2" mb={1}>
              <strong>Tracking Number:</strong> {shippingDetails.trackingNo || 'N/A'}
            </Typography>
            <Typography variant="body2">
              <strong>Tracking URL:</strong>{' '}
              <Link href={shippingDetails.trackingUrl} target="_blank" rel="noopener" underline="hover">
